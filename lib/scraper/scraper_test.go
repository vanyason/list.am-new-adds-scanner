...
func TestScrapDramShort(t *testing.T) {
	...
	expectedAds := [expectedLen]Ad{
		{"/ru/item/19279834", "250,000 ֏ в месяц", "1-комн. квартира на ул. Мамиконянца, 25 кв.м., 5/9 этаж, дизайнерский ремонт", "Арабкир, 1 ком., 25 кв.м., 5/9 этаж"},
		{"/ru/item/18789181", "250,000 ֏ в месяц", "2-комн. квартира, 2-й переулок улицы Багяна, 60 кв.м., 1/5 этаж, евроремонт, каменное здание", "Нор Норк, 2 ком., 60 кв.м., 1/5 этаж"},
	}
...
func TestScrapDifferentHtml(t *testing.T) {
	...
	expectedAds := [expectedLen]Ad{
		{"/ru/item/19279834", "250,000 ֏ в месяц", "1-комн. квартира на ул. Мамиконянца, 25 кв.м., 5/9 этаж, дизайнерский ремонт", "Арабкир, 1 ком., 25 кв.м., 5/9 этаж"},
		{"/ru/item/18789181", "250,000 ֏ в месяц", "2-комн. квартира, 2-й переулок улицы Багяна, 60 кв.м., 1/5 этаж, евроремонт, каменное здание", "Нор Норк, 2 ком., 60 кв.м., 1/5 этаж"},
		{"/ru/item/1234", "250,000 ֏ в месяц", "aa", "Арабкир, 1 ком., 25 кв.м., 5/9 этаж"},
		{"/ru/item/1234", "250,000 ֏ в месяц", "bb", "Нор Норк, 2 ком., 60 кв.м., 1/5 этаж"},
	}
